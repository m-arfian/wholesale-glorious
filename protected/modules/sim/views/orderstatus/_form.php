    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group">
                <?php echo $form->labelEx($model, 'ORDER_STATUS_NAMA', array('class' => 'col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label')); ?>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                    <?php echo $form->textField($model, 'ORDER_STATUS_NAMA', array('class' => 'form-control')); ?>
                    <?php echo $form->error($model, 'ORDER_STATUS_NAMA'); ?>
                </div>
            </div>
        </div>
    </div><hr>
