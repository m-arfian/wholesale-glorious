...
<div class="blue-block">
    <div class="page-title">
        <h3 class="pull-left"><i class="fa fa-files-o"></i> Tag <span></span></h3>
    ...
    <div class="page-content page-tables">
        ...
        <div class="widget">
            ...
            <div class="widget-head">
                <?php echo CHtml::link('<i class="fa fa-search-plus"></i> Pencarian tag', '#', array('class' => 'btn btn-xs btn-black search-button')); ?>
                <?php echo CHtml::link('<i class="fa fa-plus"></i> Tambah tag', array('create'), array('class' => 'btn btn-xs btn-success')) ?>
            </div>
