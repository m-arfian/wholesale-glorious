    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group">
                <?php echo $form->labelEx($model, 'PROVINSI_NAMA', array('class' => 'col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label')); ?>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                    <?php echo $form->textField($model, 'PROVINSI_NAMA', array('class' => 'form-control')); ?>
                    <?php echo $form->error($model, 'PROVINSI_NAMA'); ?>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group">
                <?php echo $form->labelEx($model, 'PROVINSI_STATUS', array('class' => 'col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label')); ?>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                    <div class="compactRadioGroup">
                        <?php echo $form->radioButtonList($model, 'PROVINSI_STATUS', array(
                            Provinsi::AKTIF => 'Aktif',
                            Provinsi::NONAKTIF => 'Non Aktif',
                        )); ?>
                    </div>
                    <?php echo $form->error($model, 'PROVINSI_STATUS'); ?>
                </div>
            </div>
        </div>
    </div><hr>
