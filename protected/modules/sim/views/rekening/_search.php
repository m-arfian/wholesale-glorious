...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
                    <?php echo $form->textField($model, 'REKENING_ID', array('class' => 'form-control')) ?>
                </div>
            </div>
            <div class="form-group">
                <?php echo $form->label($model, 'REKENING_BANK', array('class' => 'col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label')); ?>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            ...
            <div class="form-group">
                <?php echo $form->label($model, 'REKENING_NO', array('class' => 'col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label')); ?>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
                <?php echo $form->label($model, 'REKENING_STATUS', array('class' => 'col-lg-5 col-md-5 col-sm-5 col-xs-5 control-label')); ?>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
