...
class SubkategoriController extends Controller {
    ...
    public function actionCreate() {
        $model = new Subkategori('subkategoribaru');
        $gambar = new Gambar('subkategoribaru');
    ...
    public function actionUpdate($id) {
        $model = $this->loadModel($id);
        $model->scenario = 'editsubkategori';
//        $gambar = Gambar::model()->findByPk($model->GAMBAR_ID);
//        $gambar->scenario = 'editsubkategori';
        $gambar = new Gambar('editsubkategori');
    ...
    private function saveRecord($model, $gambar) {
        $newpath = URL::Gambar(Gambar::URL_SUBKATEGORI) . $gambar->GAMBAR_NAMA;
        ...
        try {
            ...
            $this->redirect(array('view', 'id' => $model->SUBKATEGORI_ID));
        } catch (Exception $e) {
