...
<div class="col-lg-4 col-md-6 col-sm-4 col-xs-12">
    <div class="offer offer-danger">
        <?php if(!empty($data->harga[0]->HARGA_SALE)): ?>
        <div class="shape">
        ...
        <div class="offer-content">
            <div class="item">
                ...
                <div class="item-image">
                    <?php echo CHtml::link(CHtml::image(URL::Gambar('produk') . $data->subgambar[0]->gambarsmall->GAMBAR_NAMA, '', array('class'=>'img-responsive')), array('katalog/detail', 'id' => Expr::linkForward($data->BARANG_ID, Expr::LINK_BARANG))) ?>
                </div>
                <!-- Item details -->
